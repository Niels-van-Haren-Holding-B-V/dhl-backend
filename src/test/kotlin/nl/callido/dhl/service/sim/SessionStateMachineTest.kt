...
class SessionStateMachineTest {
    ...
    private val expected: Map<SimSessionState, Set<SimEvent>> = mapOf(
        ...
        SimSessionState.READY to setOf(
            SimEvent.HAND_IN_VALIDATE, SimEvent.HAND_IN_ATTEMPT, SimEvent.HAND_OUT_START, SimEvent.FINISH,
        ),
        SimSessionState.HAND_IN_DOOR_OPEN to setOf(
            SimEvent.DOOR_CLOSED, SimEvent.HAND_IN_REPORT_SIZE, SimEvent.HAND_IN_REPORT_ISSUE,
        ),
        SimSessionState.HAND_IN_AWAITING_CONFIRM to setOf(
            SimEvent.HAND_IN_CONFIRM, SimEvent.HAND_IN_REOPEN, SimEvent.HAND_IN_REPORT_ISSUE,
        ),
        ...
        SimSessionState.HAND_OUT_DOOR_OPEN to setOf(
            SimEvent.DOOR_CLOSED, SimEvent.HAND_OUT_REPORT_MISSING, SimEvent.HAND_OUT_REPORT_ISSUE, SimEvent.HAND_OUT_ABORT,
        ),
        SimSessionState.HAND_OUT_AWAITING_CONFIRM to setOf(
            SimEvent.HAND_OUT_CONFIRM, SimEvent.HAND_OUT_REPORT_ISSUE, SimEvent.HAND_OUT_ABORT,
        ),
    ...
    @TestFactory
    fun `every state-event combination matches the expected table`(): List<DynamicTest> =
        SimSessionState.entries.flatMap { state ->
